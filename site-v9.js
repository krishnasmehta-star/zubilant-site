...
(function(){
  var nav=document.getElementById('nav'), bar=document.getElementById('sbar'),
      ...
      fields=Array.prototype.slice.call(document.querySelectorAll('.field'));
  ...
  if(pinsG){
    ...
    /* Placeholder tabs — outbound names await Sachin's list; visibly "soon" */
    ['Dubai','Bali','Vietnam'].forEach(function(name){
      var b=document.createElement('button');
      b.className='soon'; b.disabled=true;
      b.innerHTML=name+' <small>soon</small>';
      regbar.appendChild(b);
    });
    if(window.gsap && !reduced){
